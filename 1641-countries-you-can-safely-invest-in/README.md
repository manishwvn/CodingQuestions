<h2><a href="https://leetcode.com/problems/countries-you-can-safely-invest-in">Countries You Can Safely Invest In</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table <code>Person</code>:</p>
