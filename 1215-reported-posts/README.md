<h2><a href="https://leetcode.com/problems/reported-posts">Reported Posts</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>Actions</code></p>
