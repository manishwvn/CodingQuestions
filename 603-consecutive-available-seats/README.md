<h2><a href="https://leetcode.com/problems/consecutive-available-seats">Consecutive Available Seats</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>Cinema</code></p>
