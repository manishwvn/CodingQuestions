<h2><a href="https://leetcode.com/problems/maximum-transaction-each-day">Maximum Transaction Each Day</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table: <code>Transactions</code></p>
