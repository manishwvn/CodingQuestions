<h2><a href="https://leetcode.com/problems/server-utilization-time">Server Utilization Time</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Table: <code>Servers</code></p>
