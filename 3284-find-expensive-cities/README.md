<h2><a href="https://leetcode.com/problems/find-expensive-cities">Find Expensive Cities</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>Listings</code></p>
